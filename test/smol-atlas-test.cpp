...
static void test_same_height_on_same_shelf()
{
    ...
    smol_atlas_item_t* e1 = sma_add(atlas, 10, 10);
    smol_atlas_item_t* e2 = sma_add(atlas, 10, 10);
    smol_atlas_item_t* e3 = sma_add(atlas, 10, 10);
...
static void test_larger_height_new_shelf()
{
    ...
    smol_atlas_item_t* e1 = sma_add(atlas, 10, 10);
    smol_atlas_item_t* e2 = sma_add(atlas, 10, 15);
    smol_atlas_item_t* e3 = sma_add(atlas, 10, 20);
...
static void test_shorter_height_existing_best_shelf()
{
    ...
    smol_atlas_item_t* e2 = sma_add(atlas, 10, 15);
    smol_atlas_item_t* e3 = sma_add(atlas, 10, 20);
    smol_atlas_item_t* e4 = sma_add(atlas, 10, 9);
...
static void test_pack_uses_free_space()
{
    ...
    smol_atlas_item_t* e4 = sma_add(atlas, 10, 10);
...
static void test_pack_uses_least_wasteful_free_space()
{
    ...
    smol_atlas_item_t* e4 = sma_add(atlas, 10, 13);
...
static void test_pack_considers_max_dimensions_for_space_reuse()
{
    ...
    smol_atlas_item_t* e3 = sma_add(atlas, 10, 13);
    CHECK_ITEM(e3, 0, 10, 10, 13);

    sma_remove(atlas, e3);

    smol_atlas_item_t* e4 = sma_add(atlas, 10, 14);
...
static void test_pack_results_minimal_size()
{
    ...
    smol_atlas_item_t* res0 = sma_add(atlas, 10, 10);
    smol_atlas_item_t* res1 = sma_add(atlas, 5, 15);
    smol_atlas_item_t* res2 = sma_add(atlas, 25, 15);
    smol_atlas_item_t* res3 = sma_add(atlas, 10, 20);
...
static void test_pack_shelf_coalescing()
{
    ...
    // ABBCDDDD__
    smol_atlas_item_t* rA = sma_add(atlas, 10, 10);
    smol_atlas_item_t* rB = sma_add(atlas, 20, 10);
    smol_atlas_item_t* rC = sma_add(atlas, 10, 10);
    smol_atlas_item_t* rD = sma_add(atlas, 40, 10);
    ...
    // EEE_DDDD__
    smol_atlas_item_t* rE = sma_add(atlas, 30, 10);
    ...
    // FFFFFFFFF_
    smol_atlas_item_t* rF = sma_add(atlas, 90, 10);
